...
FamilyTree._defaultConfig = function (e) {
    ...
    FamilyTree._intersects = function (e, t, i) {
        ...
        return "bottom" == a ? n = e.rightNeighbor ? e.y + e.h + (e.rightNeighbor.y - (e.y + e.h)) / 2 : e.y + e.h + i.siblingSeparation / 2 : "top" == a && (n = e.leftNeighbor ? e.y + (e.leftNeighbor.y + e.leftNeighbor.h - e.y) / 2 : e.y - i.siblingSeparation / 2), t.push([t[t.length - 1][0], n]), t.push([e.x - i.levelSeparation / 3, n]), l = t[t.length - 1][0], s = n, r.p = l, r.q = n, r.s = s, r
    }, FamilyTree._addPointRight = function (e, t, i, r, a) {
        var n, l = t[t.length - 1][0];
        return "bottom" == a ? n = e.rightNeighbor ? e.y + e.h + (e.rightNeighbor.y - (e.y + e.h)) / 2 : e.y + e.h + i.siblingSeparation / 2 : "top" == a && (n = e.leftNeighbor ? e.y + (e.leftNeighbor.y + e.leftNeighbor.h - e.y) / 2 : e.y - i.siblingSeparation / 2), t.push([t[t.length - 1][0], n]), t.push([e.x + e.w + i.levelSeparation / 3, n]), l = t[t.length - 1][0], s = n, r.p = l, r.q = n, r.s = s, r
        ...
        return I.innerHTML = `<div>\n                        <div class="bft-edit-form-header" ${C}>\n                            ${A}\n                            <h1 class="bft-edit-form-title">${FamilyTree._escapeGreaterLessSign(g)}</h1>\n                            <div id="bft-avatar" class="bft-edit-form-avatar">${T}</div>                        \n                        </div>\n                        <div data-bft-edit-from-btns class="bft-edit-form-instruments">\n                        ${function () { if (a) return ""; var e = ""; for (var i in m) { var r = m[i]; FamilyTree.isNEU(r) || (w && r.hideIfEditMode || t && r.hideIfDetailsMode || l && "Edit" == r.text || (e += `<div data-edit-from-btn='${i}' class="bft-img-button" ${C} title="${r.text}">${r.icon}</div>`)) } return e }()}    \n                        </div>\n                    </div>\n                    <div class="bft-edit-form-fields">\n                        <div class="bft-edit-form-fields-inner">\n                            <div class="bft-form-fieldset">\n                                ${function () {
            for (var e = "", i = 0; i < o.length; i++) {
                var r = o[i]; if (Array.isArray(r)) { e += '<div class="bft-form-field-100 bft-form-fieldset">'; for (var a = 0; a < r.length; a++) { var l = r[a], s = FamilyTree.elements[l.type](u, l, "unset", t); !FamilyTree.isNEU(s.id) && FamilyTree.isNEU(n) && FamilyTree.isNEU(s.value) && (n = s.id), FamilyTree.isNEU(s.value) || N.push(`${l.label}: ${s.value}`), e += s.html } e += "</div>" } else {
    ...
    `), e += s.html
                ...
                (s = f[u]).addEventListener("click", (function (e) {
                    ...
                    if (void 0 === a[l].onClick)
                        if ("add" === l) {
                            ...
                            expandChildren: !1,
                            nodeId: i
                        }) : "csv" === l ? n.obj.exportCSV() : "xml" === l ? n.obj.exportXML() : "json" === l && n.obj.exportJSON();
        ...
        if (t) {
            ...
            })), t.fullScreen && (this.div.innerHTML += "<div " + FamilyTree.attr.tlbr + '="fullScreen">' + FamilyTree.toolbarUI.openFullScreenIcon + "</div>"), this.obj.element.appendChild(this.div), this.layoutBtn = this.div.querySelector("[" + FamilyTree.attr.tlbr + '="layout"]');
        ...
        if (FamilyTree._isHTML(e)) return FamilyTree._escapeHtml(e);
    ...
    FamilyTree._convertStringToArray = function (e, t) {
        ...
        return iconPng(e, t, i)
    }, FamilyTree.icon.pdf = function (e, t, i) {
        return iconPdf(e, t, i)
    }, FamilyTree.icon.svg = function (e, t, i) {
        return iconSvg(e, t, i)
    }, FamilyTree.icon.csv = function (e, t, i) {
        return iconCsv(e, t, i)
    }, FamilyTree.icon.json = function (e, t, i) {
        return iconJson(e, t, i)
    }, FamilyTree.icon.excel = function (e, t, i) {
        return iconExcel(e, t, i)
    }, FamilyTree.icon.edit = function (e, t, i) {
        return iconEdit(e, t, i)
    }, FamilyTree.icon.details = function (e, t, i) {
        return iconDetails(e, t, i)
    }, FamilyTree.icon.remove = function (e, t, i) {
        return iconRemove(e, t, i)
    }, FamilyTree.icon.add = function (e, t, i) {
        return iconAdd(e, t, i)
    }, FamilyTree.icon.search = function (e, t, i) {
        return iconSearch(e, t, i)
    }, FamilyTree.icon.xml = function (e, t, i) {
        return iconXml(e, t, i)
    }, FamilyTree.icon.link = function (e, t, i) {
        return iconLink(e, t, i)
    }, FamilyTree.icon.happy = function (e, t, i) {
        return iconHappy(e, t, i)
    }, FamilyTree.icon.sad = function (e, t, i) {
        return iconSad(e, t, i)
    }, FamilyTree.icon.share = function (e, t, i, r, a) {
        return FamilyTree.isNEU(r) && (r = 0), FamilyTree.isNEU(a) && (a = 0), iconShare(e, t, i, r, a)
    }, FamilyTree.icon.user = function (e, t, i, r, a) {
        return FamilyTree.isNEU(r) && (r = 0), FamilyTree.isNEU(a) && (a = 0), iconUser(e, t, i, r, a)
    }, FamilyTree.icon.ft = function (e, t, i, r, a) {
        return iconFt(e, t, i, r, a)
    }, FamilyTree.icon.addUser = function (e, t, i, r, a) {
        return FamilyTree.isNEU(r) && (r = 0), FamilyTree.isNEU(a) && (a = 0), iconAddUser(e, t, i, r, a)
    }, FamilyTree.icon.close = function (e, t, i, r, a) {
        return FamilyTree.isNEU(r) && (r = 0), FamilyTree.isNEU(a) && (a = 0), iconClose(e, t, i, r, a)
    }, FamilyTree.icon.daughter = function (e, t, i, r, a) {
        return FamilyTree.isNEU(r) && (r = 0), FamilyTree.isNEU(a) && (a = 0), iconDaughter(e, t, i, r, a)
    }, FamilyTree.icon.son = function (e, t, i, r, a) {
        return FamilyTree.isNEU(r) && (r = 0), FamilyTree.isNEU(a) && (a = 0), iconSon(e, t, i, r, a)
    }, FamilyTree.icon.wife = function (e, t, i, r, a) {
        return FamilyTree.isNEU(r) && (r = 0), FamilyTree.isNEU(a) && (a = 0), iconWife(e, t, i, r, a)
    }, FamilyTree.icon.husband = function (e, t, i, r, a) {
        return FamilyTree.isNEU(r) && (r = 0), FamilyTree.isNEU(a) && (a = 0), iconHusband(e, t, i, r, a)
    }, FamilyTree.icon.father = function (e, t, i, r, a) {
        return FamilyTree.isNEU(r) && (r = 0), FamilyTree.isNEU(a) && (a = 0), iconFather(e, t, i, r, a)
    }, FamilyTree.icon.mother = function (e, t, i, r, a) {
        return FamilyTree.isNEU(r) && (r = 0), FamilyTree.isNEU(a) && (a = 0), iconMother(e, t, i, r, a)
    }, FamilyTree.icon.teddy = function (e, t, i, r, a) {
        return FamilyTree.isNEU(r) && (r = 0), FamilyTree.isNEU(a) && (a = 0), iconTeddy(e, t, i, r, a)
                ...
                v = function (t) {
                    if (h) {
                        ...
                        if (s.left || s.right || s.up || s.down) {
                            ...
                            for (l.stopMove(), p.classList && (p.classList.add("bft-cursor-grab"), p.classList.remove("bft-cursor-move"), p.classList.remove("bft-cursor-nodrop"), p.classList.remove("bft-cursor-copy")), b(c, m), c = null, m = null; null != r && r != p;) {
                            ...
                            var E = (i.x - h.x) / d,
                                L = (i.y - h.y) / d;
                            if (u[4] = y + E, u[5] = g + L, !e._dragEventFired && (Math.abs(i.x - h.x) > FamilyTree.FIRE_DRAG_NOT_CLICK_IF_MOVE || Math.abs(i.y - h.y) > FamilyTree.FIRE_DRAG_NOT_CLICK_IF_MOVE)) !1 === FamilyTree.events.publish("drag", [l.nodeCircleMenuUI, {
                                from: C,
                                menuItem: n,
                                menuItemName: a
        ...
        if (this.config.enableDragDrop) {
            ...
            var s = this,
                ...
                f = s.getScale(),
                u = e.cloneNode(!0);
            d.insertBefore(u, d.firstChild), u.style.opacity = .7;
            var y = function (e, t) {
                if (null != e) {
                    t.classList.remove("bft-drag-over");
                ...
                g = function (t) {
                    if (c) {
                        ...
                        if (g.left || g.right || g.up || g.down) {
                            ...
                            if (s.stopMove(), d.classList && (d.classList.add("bft-cursor-grab"), d.classList.remove("bft-cursor-move"), d.classList.remove("bft-cursor-nodrop"), d.classList.remove("bft-cursor-copy")), y(l, o), l = null, o = null, s.config.enableDragDrop)
                                for (; null != r && r != d;) {
                                    if (r.hasAttribute && r.hasAttribute(FamilyTree.attr.node_id)) {
        ...
        if (e) {
            if (this._movePosition = e, !this._moveInterval) {
                ...
                this._moveInterval = setInterval((function () {
                    ...
                    i._movePosition.left && (n++, e.x = n * FamilyTree.MOVE_STEP / a, e.xWithoutScale = n * FamilyTree.MOVE_STEP), i._movePosition.right && (n++, e.x = -n * FamilyTree.MOVE_STEP / a, e.xWithoutScale = -n * FamilyTree.MOVE_STEP), i._movePosition.up && (l++, e.y = -l * FamilyTree.MOVE_STEP / a, e.yWithoutScale = -l * FamilyTree.MOVE_STEP), i._movePosition.down && (l++, e.y = l * FamilyTree.MOVE_STEP / a, e.yWithoutScale = l * FamilyTree.MOVE_STEP), i.setViewBox([r[0] + e.x, r[1] + e.y, r[2], r[3]]), i.xScrollUI.setPosition(), i.yScrollUI.setPosition(), t && t(e)
        ...
        if ("pan" == s.type) {
            ...
            var c = FamilyTree._getOffsetXY(this.element, t),
                m = c.x / n + a[0] - 16 / n,
                p = c.y / n + a[1] - 16 / n;
            d.style.display = "inherit", d.setAttribute("transform", "matrix(0,0,0,0," + m + "," + p + ")"), FamilyTree.animate(d, {
                transform: [0, 0, 0, 0, m, p],
                opacity: 0
            }, {
                transform: [1 / n, 0, 0, 1 / n, m, p],
                opacity: 1
        ...
        var h = function (e) {
            ...
            f = function () {
                "pan" == s.type && r.config.sticky ? setTimeout((function () {
                    ...
                    r._draw(!0, FamilyTree.action.pan)
                }), 0), s = null, d.style.display = "none", e.removeEventListener(i.move, h), e.removeEventListener(i.up, f), i.leave && e.removeEventListener(i.leave, f), i.touchstart && e.removeEventListener(i.touchstart, f)
            };
        ...
        this.obj.element.insertBefore(i, a), FamilyTree.input.init(i), this.input = document.getElementById(r.id), this.input.addEventListener("keypress", (function (e) {
            "Enter" == e.key && e.preventDefault()
        })), this.input.addEventListener("keyup", (function (e) {
            "ArrowDown" == e.key ? (e.preventDefault(), n()) : "ArrowUp" == e.key ? (e.preventDefault(), e.stopPropagation(), l()) : "Enter" == e.key ? (e.preventDefault(), o()) : "Escape" == e.key ? (e.preventDefault(), t.hide()) : t._serverSearch(this.value)
        }));
        var n = function () {
        ...
        for (var n = this.obj.element.querySelectorAll("[data-search-item-id]"), l = 0; l < n.length; l++) n[l].addEventListener("click", (function () {
        ...
        if (e.min || d != FamilyTree.action.minimize || (c.all || c.id == e.id) && (e.min = !0), !0 === e.min && d == FamilyTree.action.maximize && (c.all || c.id == e.id) && (e.min = !1), d == FamilyTree.action.init && null != m && (e.min = m.min.has(e.id)), !e.min)
        ...
        null != i.orderBy && d.sort((function (t, r) {
            var a = e[t].order,
                n = e[r].order;
        ...
        for (c = 0; c < d.length; c++) {
            var u = d[c],
                ...
                g = e[f.stpid],
                T = e[f.pid];
            if (g || (f.stpid = null), T || (f.pid = null), g) {
                var b = n ? n[g.id] : null;
                b && (g.min = b.min), g.stChildrenIds.push(f.id)
            } else T ? (y && (f.collapsed = y.collapsed, f.min = y.min), T.childrenIds.push(f.id)) : (y && (f.collapsed = y.collapsed, f.min = y.min), t.push(f), l.push(f.id));
        ...
        if (r == FamilyTree.action.init && t.expand && t.expand.nodes && null == l)
            for (c = 0; c < t.expand.nodes.length; c++) {
                ...
                for (c = 0; c < T.length; c++)
                    for (var b = o[(g = o[T[c]]).pid]; b;) y.push(b.id), null == b.pid && null != b.stpid ? (b = o[b.stpid]).min = !1 : b = o[b.pid]
        ...
        for (c = 0; c < C.length; c++) {
            ...
            for (F = 0; F < g.children.length; F++) {
                (R = g.children[F]).isAssistant ? I.push(R.id) : -1 != R.tags.indexOf("right-partner") ? (R.isPartner = 1, R.children = [], N.push(R.id)) : -1 != R.tags.indexOf("left-partner") ? (R.isPartner = 2, R.children = [], A.push(R.id)) : -1 == R.tags.indexOf("partner") || E % 2 ? -1 != R.tags.indexOf("partner") && E % 2 ? (R.isPartner = 2, R.children = [], A.push(R.id), E++) : R.parentPartner ? (M[R.parentPartner.id] || (M[R.parentPartner.id] = []), M[R.parentPartner.id].push(R.id)) : I.push(R.id) : (R.isPartner = 1, R.children = [], N.push(R.id), E++)
            }
            g.children = [];
            var P = [];
            for (F = 0; F < N.length; F++) {
                M[(R = o[N[F]]).id] ? g.children.push(R) : g.children.splice(0, 0, R);
                for (var D = 0; D < R.childrenIds.length; D++) P.push(R.childrenIds[D])
            }
            var z = [];
            for (F = 0; F < A.length; F++) {
                M[(R = o[A[F]]).id] ? g.children.push(R) : g.children.splice(0, 0, R);
                for (D = 0; D < R.childrenIds.length; D++) z.push(R.childrenIds[D])
            }
            for (F = 0; F < z.length; F++) {
                (R = o[z[F]]).collapsed || (R.parentPartner = R.parent, R.parent = g, R.isChildOfPartner = !0, g.children.push(R))
            }
            for (F = A.length - 1; F >= 0; F--)
                if (M[A[F]])
                    for (u = 0; u < M[A[F]].length; u++) g.children.push(o[M[A[F]][u]]), L++, -1 == O.indexOf(A[F]) && O.push(A[F]);
            ...
            for (F = 0; F < N.length; F++)
                if (M[N[F]])
                    for (u = 0; u < M[N[F]].length; u++) g.children.push(o[M[N[F]][u]]), U++, -1 == B.indexOf(N[F]) && B.push(N[F]);
            for (F = 0; F < P.length; F++) {
                (R = o[P[F]]).collapsed || (R.parentPartner = R.parent, R.parent = g, R.isChildOfPartner = !0, g.children.push(R))
            }
            g.partnerSeparation = Math.max(O.length, B.length) * t.partnerChildrenSplitSeparation + t.minPartnerSeparation, I.length || !L || U ? I.length || L || !U ? I.length || 1 != L || 1 != U ? I.length || L || U ? !I.length || L || U ? I.length && (L || U) ? g.hasPartners = 7 : g.hasPartners = 1 : g.hasPartners = 6 : g.hasPartners = 5 : g.hasPartners = 4 : g.hasPartners = 3 : g.hasPartners = 2
        }
        for (c = 0; c < k.length; c++) {
            if ((ae = i[(g = o[k[c]]).lcn ? g.lcn : "base"]).layout == FamilyTree.normal || !S[g.pid])
                for (F = 0; F < g.subLevels; F++) {
                    var H, j = new FamilyTree.node(g.id + "_sub_level_index_" + F, g.pid, [], "subLevel");
                    if (FamilyTree.manager._initDinamicNode(j, g.lcn), b = g.parent) (H = b.children.indexOf(g)) > -1 && (b.children.splice(H, 1), b.children.splice(H, 0, j)), j.children.push(g), j.parent = b, g.parent = j, o[j.id] = j
                }
        }
        for (var $ in w) {
            (b = o[$]).hasAssistants = !0;
            ...
            for (F = b.children.length - 1; F >= 0; F--) {
                (R = b.children[F]).isAssistant ? (R.parent = null, b.children.splice(F, 1), Y.splice(0, 0, R.id)) : R.isPartner || (R.parent && S[R.parent.id] && j && R.parent.id != j.id && (Object.defineProperty(S, j.id, Object.getOwnPropertyDescriptor(S, R.parent.id)), delete S[R.parent.id]), R.parent = j, j.children.unshift(R), b.children.splice(F, 1))
            }
            if (Y.length % 2) {
        ...
        if (Q || te) {
            ...
            for (var $ in S) {
                ...
                if ((ae = i[b.lcn ? b.lcn : "base"]).layout == FamilyTree.mixed || ae.layout == FamilyTree.tree || ae.layout == FamilyTree.treeRightOffset || ae.layout == FamilyTree.treeLeftOffset || te)
                    if (ie.pnode = b, ie.layout = ae.layout, ie.childrenIds = S[$], ie.lastChildrenPidIds = S, FamilyTree.events.publish("node-layout", [e, ie]), FamilyTree.events.publish("layout", [ie]), ie.layout == FamilyTree.mixed) {
                        var ne = ie.childrenIds;
                        for (c = ne.length - 1; c >= 0; c--) {
                            b = (R = o[ne[c]]).parent, R.layout = FamilyTree.mixed;
                            for (F = b.children.length - 1; F >= 0; F--)
                                if (R.id == b.children[F].id) {
                                    b.children.splice(F, 1);
                                    break
                                } if (c > 0) {
                                    var le = o[ne[c - 1]];
                                    R.parent = le, R.layout = FamilyTree.mixed, le.children.push(R)
                        ...
                        for (c = ie.childrenIds.length - 1; c >= 0; c--) {
                            for (R = o[ie.childrenIds[c]], F = 0; F < b.children.length; F++) b.children[F].id == R.id && b.children.splice(F, 1);
                            if (R.parent = null, R.layout = FamilyTree.tree, ie.layout == FamilyTree.treeRightOffset && oe.splice(0, 0, R.id), ie.layout == FamilyTree.treeLeftOffset || ie.layout == FamilyTree.treeRightOffset) {
                                var se = new FamilyTree.node(R.id + "_mirror", re.id, [], "mirror");
                                FamilyTree.manager._initDinamicNode(se, R.lcn), se.layout = FamilyTree.tree, o[se.id] = se, oe.splice(0, 0, se.id)
                            }
                            ie.layout != FamilyTree.treeRightOffset && oe.splice(0, 0, R.id)
                        }
                        ...
                        for (F = 0; F < oe.length; F += 3) {
                            ...
                            0 != F && (G = o[oe[F - 3]]), 0 == F || J || (G = o[oe[F - 2]]), K.parent = G, G.children.push(K), J && (0 != F && (G = o[oe[F - 2]]), J.parent = G, G.children.push(J)), Z && (0 != F && (G = o[oe[F - 1]]), Z.parent = G, G.children.push(Z))
                        }
                    }
            }
        }
        ...
        for (var s = i.nodes, d = [], c = {}, m = {}, p = 0; p < s.length; p++) {
            var h, f = s[p];
            h = FamilyTree.STRING_TAGS ? f.tags ? f.tags.split(",") : [] : Array.isArray(f.tags) ? f.tags.slice(0) : [], o.filterUI.addFilterTag(f) && h.push("filter"), f.gender && h.push(f.gender);
            var u = FamilyTree._getTemplate(h, i.tags, i.template);
            f.templateName && (u = f.templateName);
            var y = new FamilyTree.node(f.id, f.pid, h, u);
            y.ftChildrenIds = [], y.rids = [], FamilyTree.isNEU(f.ppid) || (y.ppid = f.ppid), FamilyTree.isNEU(f.stpid) || (y.stpid = f.stpid), FamilyTree.isNEU(f.mid) || (y.mid = f.mid), FamilyTree.isNEU(f.fid) || (y.fid = f.fid), FamilyTree.isNEU(f.gender) || (y.gender = f.gender), Array.isArray(f.pids) ? y.pids = f.pids : y.pids = [], null != i.orderBy && (y.order = FamilyTree.manager._getOrderFieldValue(f, i.orderBy)), e[f.id] = y, FamilyTree.isNEU(y.stpid) ? (FamilyTree.isNEU(y.mid) || (c[y.mid] || (c[y.mid] = []), c[y.mid].push(y.id)), FamilyTree.isNEU(y.fid) || (c[y.fid] || (c[y.fid] = []), c[y.fid].push(y.id)), FamilyTree.isNEU(y.mid) && FamilyTree.isNEU(y.fid) && FamilyTree.isNEU(y.stpid) && (d.has(y.id) || d.push(y.id))) : (m[y.stpid] || (m[y.stpid] = []), m[y.stpid].push(y.id))
        }
        if (null != i.orderBy && c)
            for (var g in c) c[g].sort((function (t, r) {
                var a = e[t].order,
                    n = e[r].order;
                return "number" == typeof a || "number" == typeof n ? (null == a && (a = -1), null == n && (n = -1), i.orderBy.desc ? n - a : a - n) : "string" == typeof a || "string" == typeof n ? (null == a && (a = ""), null == n && (n = ""), i.orderBy.desc ? n.localeCompare(a) : a.localeCompare(n)) : void 0
            }));
        for (p = 0; p < d.length; p++) {
            ...
            if (T) {
                var b = [];
                FamilyTree.manager._iterateSetRootIds(T.id, T.id, m, c, e, b), l.push(b)
            }
        }
        for (p = 0; p < l.length; p++)
            for (var v = 0; v < l.length; v++)
                if (v != p) {
                    for (var F = l[p], x = l[v], _ = !1, w = 0; w < F.length; w++)
                        if (x.has(F[w])) {
                            _ = !0;
                            break
                        } _ && (l[p] = F.concat(x).unique(), l[v] = [])
            ...
            if (r !== FamilyTree.action.exporting && !t.isSplit) {
                ...
                if (t.childrenIds.length > 0) {
                    ...
                    if (-1 != n.indexOf("{collapsed-children-total-count}")) {
                        var h = FamilyTree.collapsedChildrenTotalCount(e, t);
                        n = n.replace("{collapsed-children-total-count}", h)
                    }
                }
        ...
        _linkTopToBottom: function (e, t, i, r, a) {
            ...
            return n = e.x + e.w / 2 + i.linkAdjuster.toX, l = e.y + e.h + i.linkAdjuster.toY, s = o = t.x + t.w / 2 + i.linkAdjuster.fromX, d = t.y + i.linkAdjuster.fromY, {
                ...
                ya: l,
                xb: n,
                yb: c = e.rightNeighbor && e.rightNeighbor.isAssistant && "split" == t.templateName ? e.rightNeighbor.y + e.rightNeighbor.h + r : "split" != e.templateName || !t.isAssistant && 2 != t.layout ? "split" == t.templateName ? l + r : null != a ? a : d - r : d,
                xc: o,
                yc: c,
                xd: s,
                yd: d,
        ...
        _linkBottomToTop: function (e, t, i, r, a) {
            ...
            return n = e.x + e.w / 2 + i.linkAdjuster.toX, l = e.y + i.linkAdjuster.toY, s = o = t.x + t.w / 2 + i.linkAdjuster.fromX, d = t.y + t.h + i.linkAdjuster.fromY, {
                ...
                ya: l,
                xb: n,
                yb: c = e.rightNeighbor && e.rightNeighbor.isAssistant && "split" == t.templateName ? e.rightNeighbor.y - r : "split" != e.templateName || !t.isAssistant && 2 != t.layout ? "split" == t.templateName ? l - r : null != a ? a : d + r : d,
                xc: o,
                yc: c,
                xd: s,
                yd: d,
        ...
        _linkRightToLeft: function (e, t, i, r, a) {
            ...
            return n = e.x + i.linkAdjuster.toX, l = e.y + e.h / 2 + i.linkAdjuster.toY, d = t.x + t.w + i.linkAdjuster.fromX, c = s = t.y + t.h / 2 + i.linkAdjuster.fromY, o = l, 90, {
                xa: n,
                ya: l,
                xb: m = e.rightNeighbor && e.rightNeighbor.isAssistant && "split" == t.templateName ? e.rightNeighbor.x - r : "split" != e.templateName || !t.isAssistant && 2 != t.layout ? "split" == t.templateName ? n - r : null != a ? a : d + r : d,
                yb: o,
                xc: m,
                yc: s,
                xd: d,
        ...
        _linkLeftToRight: function (e, t, i, r, a) {
            ...
            return n = e.x + e.w + i.linkAdjuster.toX, l = e.y + e.h / 2 + i.linkAdjuster.toY, d = t.x + i.linkAdjuster.fromX, c = s = t.y + t.h / 2 + i.linkAdjuster.fromY, o = l, 270, {
                xa: n,
                ya: l,
                xb: m = e.rightNeighbor && e.rightNeighbor.isAssistant && "split" == t.templateName ? e.rightNeighbor.x + e.rightNeighbor.w + r : "split" != e.templateName || !t.isAssistant && 2 != t.layout ? "split" == t.templateName ? n + r : null != a ? a : d - r : d,
                yb: o,
                xc: m,
                yc: s,
                xd: d,
    ...
    FamilyTree.pdfPrevUI.show = function (e, t) {
        ...
        for (var i, r, a, n, l, o = "", s = 0; s < this.config.clinks.length; s++) {
            ...
            if (c && -1 != t.res.visibleNodeIds.indexOf(c.id) && (m && -1 != t.res.visibleNodeIds.indexOf(m.id))) {
                ...
                switch (this.config.orientation) {
                    case FamilyTree.orientation.top:
                    case FamilyTree.orientation.top_left:
                        T <= b ? (x = 1, y.x = T + c.w / 10, g.x = b - m.w / 10) : (x = -1, y.x = T - c.w / 10, g.x = b + m.w / 10), h == u ? (x = 1, y.y = h, g.y = u) : h > u ? (y.y = h, g.y = u + m.h) : (y.y = h + c.h, g.y = u);
                        break;
                    case FamilyTree.orientation.bottom:
                    case FamilyTree.orientation.bottom_left:
                        T <= b ? (x = -1, y.x = T + c.w / 10, g.x = b + m.w / 10) : (x = 1, y.x = T - c.w / 10, g.x = b + m.w / 10), h == u ? (x = -1, y.y = h + c.h, g.y = u + m.h) : h > u ? (y.y = h, g.y = u + m.h) : (y.y = h + c.h, g.y = u);
                        break;
                    case FamilyTree.orientation.left:
                    case FamilyTree.orientation.left_top:
                        v <= F ? (x = -1, y.y = v + c.h / 5, g.y = F + m.h / 5) : (x = 1, y.y = v - c.h / 5, g.y = F + m.h / 5), p == f ? (x = -1, y.x = p, g.x = f) : p > f ? (y.x = p, g.x = f + m.w) : (y.x = p + c.w, g.x = f);
                        break;
                    case FamilyTree.orientation.right:
                    case FamilyTree.orientation.right_top:
                        v <= F ? (x = 1, y.y = v + c.h / 5, g.y = F + m.h / 5) : (x = -1, y.y = v - c.h / 5, g.y = F + m.h / 5), p == f ? (x = 1, y.x = p + c.w, g.x = f + m.w) : p > f ? (y.x = p, g.x = f + m.w) : (y.x = p + c.w, g.x = f)
                }
                var _ = I(y, g, x),
                    w = d.template;
                w || (w = "orange");
                var k = FamilyTree.clinkTemplates[w],
                    S = (i = y, a = _, n = void 0, l = void 0, n = ((r = g).x - i.x) / 2 + i.x, l = (r.y - i.y) / 2 + i.y, {
                        x: (n - a.x) / 2 + a.x,
                        y: (l - a.y) / 2 + a.y
                    });
                d.label && (o += k.label.replace("{x}", S.x).replace("{y}", S.y).replace("{val}", d.label));
                var C = "M" + y.x + "," + y.y + "C" + y.x + "," + y.y + " " + _.x + "," + _.y + " " + g.x + "," + g.y;
                o += ("<g " + FamilyTree.attr.c_link_from + '="{from}" ' + FamilyTree.attr.c_link_to + '="{to}">').replace("{from}", c.id).replace("{to}", m.id) + k.link.replaceAll("{d}", C) + '<path stroke="transparent" stroke-width="15" fill="none" d="' + C + '" />', o += FamilyTree.grCloseTag
            }
        ...
        function n(t, n, l) {
                ...
                for (var y = t; null == d;) {
                    ...
                    if (!g) {
                        var F = s[s.length - 1][0],
                            x = 0;
                        if (T.parent) switch (f = p.levelSeparation, T.parent.layout != FamilyTree.mixed && T.parent.layout != FamilyTree.tree || (f = p.mixedHierarchyNodesSeparation), p.orientation) {
                            case FamilyTree.orientation.top:
                            case FamilyTree.orientation.top_left:
            ...
            if (o.label) {
                ...
                i += h.label.replace("{x}", S.x).replace("{y}", S.y + E).replace("{val}", o.label)
            }
            var L = t.id,
                U = n.id;
            l && (L = n.id, U = t.id), i += ("<g " + FamilyTree.attr.s_link_from + '="{from}" ' + FamilyTree.attr.s_link_to + '="{to}">').replace("{from}", L).replace("{to}", U) + h.link.replaceAll("{d}", N) + '<path stroke="transparent" stroke-width="15" fill="none" d="' + N + '" />', i += FamilyTree.grCloseTag
        }
        ...
        right: void 0,
        bottom: "padding"
    }, FamilyTree._search = {}, FamilyTree._search.search = function (e, t, i, r, a, n) {
        var l = [],
        ...
        var f = Math.round(1e4 * (m + p + d + h));
        f > 1e6 && (f = 1e6), n.sort((function (e, t) {
        ...
        if (e) {
            ...
            if (e.readFromUrlParams) {
                ...
                if (n.has(a.paramScale) && n.has(a.paramX) && n.has(a.paramY) && n.has(a.paramExp) && n.has(a.paramRoots) && n.has(a.paramMin) && n.has(a.paramAdjustify)) {
                    var l = {},
                        o = parseFloat(n.get(a.paramScale)),
                        s = parseFloat(n.get(a.paramX)),
                        d = parseFloat(n.get(a.paramY));
                    (m = [])[0] = s, m[1] = d, m[2] = t / o, m[3] = i / o, l.vb = m, l.scale = o, l.x = s, l.y = d, l.exp = n.get(a.paramExp).split("*"), l.roots = n.get(a.paramRoots).split("*"), l.min = n.get(a.paramMin).split("*");
        ...
        if (n || l) {
            ...
            if (o && (null != o.timer && clearInterval(o.timer), null != o.timerBack && clearInterval(o.timerBack), l.setAttribute("transform", "matrix(" + o.transformStart.toString() + ")"), FamilyTree._magnify[e]), i) l = l.cloneNode(!0), this.getSvg().appendChild(l);
        ...
        for (g = 0; g < o.length; g++)
            if (o[g].fid == c.id && FamilyTree.isNEU(o[g].mid) || o[g].mid == c.id && FamilyTree.isNEU(o[g].fid)) {
                ...
                "male" == c.gender ? (T.templateName = "wife", T._ft_partnerData.gender = "female") : "female" == c.gender && (T.templateName = "husband", T._ft_partnerData.gender = "male"), c.pids.push(T.id), m.push(T), o[g].fid == c.id ? o[g].mid = "_ft_partner_for_single_child" : o[g].mid == c.id && (o[g].fid = "_ft_partner_for_single_child"), m.push(o[g])
            } var b = {
                nodes: m,
                node: c
            };
